...
if (isset($_SESSION['Aid'])) {
    $query="SELECT p.p_no,p.p_name,e.name,p.start_date,p.fianl_date,c.c_name from employee e,project p,client c,project_state ps where c.client_id=p.client_id and e.emp_id=p.mgr_id and ps.pno=p.p_no and ps.p_status=7;";
